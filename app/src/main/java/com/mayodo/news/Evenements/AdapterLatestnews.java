...
public class AdapterLatestnews extends RecyclerView.Adapter<AdapterLatestnews.RecyclerVH> {
    Context c;
    private LayoutInflater inflater;
    ArrayList<EvenmentDataBean> arrEvenementList;
    OnNewsidSelectedListner1 onNewsidSelectedListner1;
    SharedObjects sharedObjects;
    public AdapterLatestnews(Context c, ArrayList<EvenmentDataBean> spacecrafts) {
        this.c = c;
        this.arrEvenementList = spacecrafts;
        inflater = (LayoutInflater) c.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public void setOnNewsidSelectedListner1(OnNewsidSelectedListner1 onNewsidSelectedListner1) {
        this.onNewsidSelectedListner1 = onNewsidSelectedListner1;
    }

    public interface OnNewsidSelectedListner1 {
        void setOnNewsidSelatedListner1(int position, EvenmentDataBean evenmentDataBean);
    }
    ...
    public void onBindViewHolder(RecyclerVH holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onNewsidSelectedListner1.setOnNewsidSelatedListner1(position, arrEvenementList.get(position));
            }
        });
    }
