package com.mayodo.news.fragments;
...
public class ChannelFragment extends Fragment {
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyBlYoF0N02nSmhqcMuewyguMKrzjiq3jqY";//here you should use your api key for testing purpose you can use this api also
    private static String CHANNEL_ID = "UCiO56RJs1_HSN-TGv5jDOdA"; //here you should use your channel id for testing purpose you can use this api also
